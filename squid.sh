...
msg_bar
echo -e "[~] CONFIGURA AUTOMATICAMNETE EL PUERTO SQUID"
msg_bar
echo -e "[~] UBUNTU 18.04, 19.04, 22.04"
sleep 2s
msg_bar
echo -e "[~] DETECTECTANDO SISTEMA OPERATIVO ESPERE......"
sleep 3s
...
echo -e "${cor[1]}[${cor[2]}01${cor[1]}]⇨${cor[6]} Remover Host de Squid"
echo -e "${cor[1]}[${cor[2]}01${cor[1]}]⇨${cor[6]} Desinstalar Squid"
echo -e "${cor[1]}[${cor[2]}04${cor[1]}]⇨${cor[6]} Volver"
msg_bar
